...
% Equation 1
\begin{dmath}
{x}_{t}={x}_{t+1}-\left({r}_{t}-{{\pi_h}}_{t+1}-{{\bar r}}_{t}\right)\, \left(\frac{{\sigma}}{1-{\alpha}+{\alpha}\, \left({\sigma}\, {\gamma}+\left(1-{\alpha}\right)\, \left({\sigma}\, {\eta}-1\right)\right)}\right)^{\left(-1\right)}
\end{dmath}
% Equation 2
\begin{dmath}
{{\pi_h}}_{t}={\beta}\, {{\pi_h}}_{t+1}+{x}_{t}\, \frac{\left(1-{\beta}\, {\theta}\right)\, \left(1-{\theta}\right)}{{\theta}}\, \left({\varphi}+\frac{{\sigma}}{1-{\alpha}+{\alpha}\, \left({\sigma}\, {\gamma}+\left(1-{\alpha}\right)\, \left({\sigma}\, {\eta}-1\right)\right)}\right)
\end{dmath}
% Equation 3
\begin{dmath}
